...
<html lang="en">
    ...
    <body class ="success">
       ...
       <div class="row">
       	<div class="col-md-12">
       		<center><h3 class = "primary">Room Booking Page</h3></center>
       	</div>
       </div><br><br>
       <center><h5 class="warning">Room Type:-  Single Non Ac Rooms</h5></center><br>
        <div class="row">
            <?php
        ...
        <center><h5 class="warning">Room Type:-  Single Ac Rooms</h5></center><br>
        <div class="row">
            <?php
                $connection = mysqli_connect("localhost","root","");
                $db = mysqli_select_db($connection,"royal_hotel");
        ...
        <center><h5 class="warning">Room Type:-  Double Non-Ac Rooms</h5></center><br>
        <div class="row">
            <?php
                $connection = mysqli_connect("localhost","root","");
                $db = mysqli_select_db($connection,"royal_hotel");
        ...
        <center><h5 class="warning">Room Type:-  Double Ac Rooms</h5></center><br>
        <div class="row">
            <?php
                $connection = mysqli_connect("localhost","root","");
                $db = mysqli_select_db($connection,"royal_hotel");
